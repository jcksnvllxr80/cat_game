...
export class Level3Scene extends Phaser.Scene {
  ...
  update() {
    ...
    // Fall into water
    if (this.player.y > 540 && !this.player.getData('pitCooldown')) {
      this.player.setData('pitCooldown', true);
      this.loseLife("Fell in water!", Math.max(100, this.player.x - 100), 400);
    }
  }
